...
I have developed a simple flutter project, a mobile application using Dart programming language. It can perform all the basic algebraic calculations, involving two or more numbers. 
